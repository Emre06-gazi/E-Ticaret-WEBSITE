    ...
    <div class="product-details-view-content sp-normal-content pt-60">
        ...
        <div class="product-additional-info">
            <div class="product-social-sharing">
                <ul>
                    <li class="facebook"><a href="https://tr-tr.facebook.com/business/industries/ecommerce"><i class="fa fa-facebook"></i>Facebook</a></li>
                    <li class="twitter"><a href="https://twitter.com/eticareturkiye?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><i class="fa fa-twitter"></i>Twitter</a></li>
                    <li class="google-plus"><a href="https://www.youtube.com/watch?v=_rc7o3FZXBE"><i class="fa fa-google-plus"></i>Google +</a></li>
                    <li class="instagram"><a href="https://www.instagram.com/eticareturkiye/"><i class="fa fa-instagram"></i>Instagram</a></li>
                </ul>
            </div>
        </div>
    </div>
