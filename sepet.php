                ...
                <div class="col-12">
                    <div class="coupon-all">
                        <div class="coupon">
                            ...
                            <input class="button" name="apply_coupon" value="Kuponu Gir" type="submit">
                        </div>
                        <form action="card.php" method="post">
                            <div class="coupon2">
                                <a href="card.php" class="button" name="update_cart" value="Kartı Düzenle" type="submit">Kartı Düzenle/Ekle</a>
                            </div>
                        </form>
                    </div>
                </div>
