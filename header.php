                ...
                <div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0">
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                   ...
                                   <?php  } ?>
                                    ...
                                    <input type="text" name="aranacakkelime" placeholder="Aradığınız kelimeyi girin veya yan taraftan seçiniz.">
                ...
                <script>
                    $(document).ready(function () {
                        $(".select-search-category").on("change", function () {
                            ...
                            $("input[name='aranacakkelime']").val(selectedCategoryText);
                            
                            $("button[name='kelimearama']").trigger("click");
                        });
                    });
                </script>
            </header>