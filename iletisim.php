...
<title>E-Ticaret İletişim</title>
                    ...
                    <div class="row">
                        <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            <div class="contact-page-side-content">
                                ...
                                <p class="contact-page-message mb-25">Yan taraftan bize mesaj bırakabilir veya alt taraftan bize ulaşabilirsiniz.</p>
                                <div class="single-contact-block">
                                    <h4><i class="fa fa-fax"></i> Adres</h4>
                                    <p>Sincan/ANKARA Türkiye</p>
                                </div>
                                <div class="single-contact-block">
                                    <h4><i class="fa fa-phone"></i> Telefon</h4>
                                    <p>Mobile: (09) 545 123 45 67</p>
                                </div>
                                <div class="single-contact-block last-child">
                                    <h4><i class="fa fa-envelope-o"></i> Email</h4>
                                    <p>emre_1213312@hotmail.com</p>
                                </div>
                            </div>
                        </div>
